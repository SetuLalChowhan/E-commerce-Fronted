        ...
        <div>
          <form className="flex flex-col gap-7 p-2">
            ...
            <div className="flex justify-between">
              ...
              <div>
                <Link to="" className="text-md text-blue-800 font-semibold">
                  Forgot password?
                </Link>
              </div>
            </div>
            ...
            <div>
              <p>Don't have an account yet? <button onClick={()=>{navigate('/register')}}  className="text-blue-800 font-semibold hover:border-b-2 border-b-indigo-800">Sign Up</button></p>
            </div>
          </form>
        </div>
      </div>
